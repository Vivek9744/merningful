...
export default function Profile(props) {
  ...
  const getProPost = async () => {
    ...
    const found = response.data.find(
      (element) => element._id === "640c9bfa9e9227d0fbe13f24"
    );
    console.log(found);
    ...
    <>
      ...
      >
        <div style={{ width: "128px", marginLeft: "12%" }}>
          ...
          <img
            src={
              props.props.picture === "gfgh" ||
              props.props.picture ===
                "https://images.pexels.com/photos/360591/pexels-photo-360591.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                ? "user.png"
                : props.props.picture
            }
          ></img>
